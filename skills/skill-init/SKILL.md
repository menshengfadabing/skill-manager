...
Produce a **small** enabled skill list for the **current project** (default). Prefer 5–10 skills max.
...
```bash
skill create <project-profile>
skill use <project-profile>
...
Global house-keeping only with `-g`.
